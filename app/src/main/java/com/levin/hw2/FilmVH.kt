...
//        filmposterIV.background = item.context.resources.getDrawable(resID,null)
        if (item.favor)  filmfavorIV.background = item.context.resources.getDrawable(R.drawable.is_favor)
        else filmfavorIV.background = item.context.resources.getDrawable(R.drawable.no_favor)
